    ...
    $.supr = function(element, options) {
        ...
        plugin.setCurrentClass = function (mainNavLinkAll, url) {
            mainNavLinkAll.each(function(index) {
                ...
                var url2 = url.replace('/Admin/', '');                
                //console.log(url); 
                var href2 = href.replace('/Admin/', '');
                var href2 = href2.replace('/Admin', 'Admin');
                //console.log(href2);
                if (href2 === url2) {                    
        ...
        plugin.breadCrumbs = function () {
            ...
            //empty curmb
            breadcrumb.empty();
            breadcrumb.append('<li>Você está em:</li>');
            breadcrumb.append('<li><a href="/Admin" class="tip" title="back to dashboard">'+homeIcon+'</a></li>');
