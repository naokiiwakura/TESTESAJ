...
namespace CFC.Areas.Admin.Controllers
{
    ...
    public class EstadosController : Controller
    {
        ...
        {
            var data = (from x in db.Estados.ToList()
            select new
            {
                x.CodigoDoEstado,
                x.NomeDoEstado                        
            ...
            {
               data = data.Where(c => c.NomeDoEstado.Contains(param.sSearch));
            }
        ...
        public ActionResult Create([Bind(Include = "CodigoDoEstado,NomeDoEstado")] Estados estados)
        {
